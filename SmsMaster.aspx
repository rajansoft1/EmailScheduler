<%@ Page Title="" Language="C#" MasterPageFile="~/scheduler.master" AutoEventWireup="true" CodeFile="SmsMaster.aspx.cs" Inherits="SmsMaster" %>
    ...
    <div class="row-fluid sortable ui-sortable">
            <div class="box span6">
                <div class="box-header">
                    <h2>
                        <i class="halflings-icon align-justify"></i><span class="break"></span>Contact Master</h2>
                    <div class="box-icon">
						...
						<div class="form-horizontal">
							<fieldset>
							  ...
							  <div class="control-group">
							   ...
							   <div class="control-group">
								<label class="control-label" for="focusedInput">Sending date</label>
								<div class="controls">
                                    <asp:TextBox ID="txtSendingDate" CssClass="input-xlarge focused" runat="server"></asp:TextBox>
								  
								</div>
							  </div>
                              <div class="control-group">
								<label class="control-label" for="focusedInput">Repeat After</label>
								<div class="controls">
                                    <asp:TextBox ID="txtRepeatAfter" CssClass="input-xlarge focused" runat="server"></asp:TextBox>
								  
								</div>
							  </div>
							   <div class="control-group">
								<label class="control-label" for="focusedInput">No of times</label>
								<div class="controls">
                                    <asp:TextBox ID="txtNoOfTimes" CssClass="input-xlarge focused" runat="server"></asp:TextBox>
								  
								</div>
							  </div>
                              <div class="control-group">
							  <label class="control-label" for="fileInput">Excel File</label>
							  <div class="controls">
